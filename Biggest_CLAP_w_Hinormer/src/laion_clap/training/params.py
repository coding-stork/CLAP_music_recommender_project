...
def parse_args():
    ...
    parser.add_argument(
        ...
        type=int,
        default=None,
        help="The length of the node neighbors sampling sequence",
    )
    parser.add_argument(
        "--datasetpath",
        type=str,
    ...
    parser.add_argument(
        ...
        type=int,
        default=512,
        help='Dimension of the node hidden state. Default is 512 so that its compatible with HTSAT')
    parser.add_argument(
        '--h_num-layers',
        type=int,
        default=4,
        help='The number of layers of HINormer layer')
    parser.add_argument(
        '--h_num-gnns',
        type=int,
        default=4,
    ...
    parser.add_argument(
        '--hinormer_weights_path',
        type=str,
        default=None,
        help='Path to the hinormer weights checkpoint')
