...
print("prima algos")
if os.path.exists("data/algos.pyx"):
    import data.algos as algos
else:
    import Relphormer.data.algos as algos
...
if os.path.exists("models/utils.py"):
    ...
    from Relphormer.models.utils import get_entity_spans_pre_processing
...
def get_dataset(args, processor, label_list, tokenizer, mode):
    ...
    if mode == "train":
        ...
        train_examples_2 = processor.get_dev_examples(args.data_dir)
        train_examples_3 = processor.get_test_examples(args.data_dir)
        train_examples = train_examples + train_examples_2 + train_examples_3
    elif mode == "dev":
    ...
    for f_id, f in enumerate(features):
        ...
        if args.pretrain == 0:
            ...
            for i,t in enumerate(f['input_ids']):
                ...
                # å¦‚æžœç­‰äºŽUNKï¼Œ popå‡ºå›¾èŠ‚ç‚¹listï¼Œç„¶åŽæ›¿æ¢
