...
class BaseLitModel(pl.LightningModule):
    ...
    def num_training_steps(self) -> int:
        ...
        # Updated num_devices calculation
        num_devices = max(1, self.trainer.num_devices)  # For newer PyTorch Lightning

        if hasattr(self.trainer, 'tpu_cores') and self.trainer.tpu_cores:
