...
class TransformerLitModel(BaseLitModel):
    def __init__(self, model, args, tokenizer=None, data_config={}):
        ...
        print("transformer lit args: ",args)
        self.save_hyperparameters(args.to_dict())
        if args.bce:
        ...
        # resize the word embedding layer or it won't work
    ...
    def validation_step(self, batch, batch_idx):
        ...
        output = {"ranks": some_rank_computation(batch)}
        self.validation_outputs.append(output)
        return result

    def on_validation_epoch_end(self):
        ranks = np.concatenate([_['ranks'] for _ in self.validation_outputs])
